...
- Fixed a bug where the certificates embedded in a timestamp token were treated as
  trusted when verifying that token.
...
- macOS wheels are now self-contained: OpenSSL is vendored and statically linked
  ...
  install ([#276](https://github.com/trailofbits/rfc3161-client/pull/276))
...
[Unreleased]: https://github.com/trailofbits/rfc3161-client/compare/v1.0.9...HEAD
[1.0.9]: https://github.com/trailofbits/rfc3161-client/compare/v1.0.8...v1.0.9
